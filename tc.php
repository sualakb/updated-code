      ...
      <img src="tci.jpeg" alt="IMG">
			...
			<form action="tcout.php" method="post" class="contact1-form validate-form">
				...
				<span class="contact1-form-title">
					...
					<input class="input1" type="text" name="id"required placeholder="ID">
					<span class="shadow-input1"></span>
				</div>

									<div class="wrap-input1 validate-input" data-validate = "Email is required">
					<input class="input1" type="email" name="email"required placeholder="Email">
					<span class="shadow-input1"></span>
</div>

									<div class="wrap-input1 validate-input" data-validate = "Phone is required">
					<input class="input1" type="text" pattern="[0-9]{10}" name="phone"required placeholder="Phone">
					<span class="shadow-input1"></span>
	</div>

    <div class="wrap-input1 validate-input" data-validate = "DOB is required">
					<input class="input1" type="date" name="dob" required placeholder="Date of Birth">
					<span class="shadow-input1"></span>
	</div>

	<input type="checkbox" required><span>I agree to the <u><b><a href="tcc.html">Privacy Policy</a></b></u> for BR Ambedkar Institute of Technology.</span><br>
    <button class="button" id="ButSubmit">Submit</button>
